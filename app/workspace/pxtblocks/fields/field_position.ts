...
export class FieldPosition extends FieldSlider implements FieldCustom {
    ...
    protected renderScreenPicker() {
        ...
        Blockly.browserEvents.bind(this.selectorDiv_, 'mousemove', this, (e: MouseEvent) => {
        ...
        Blockly.browserEvents.bind(this.selectorDiv_, 'mouseleave', this, this.resetCrosshair);

        Blockly.browserEvents.bind(this.selectorDiv_, 'click', this, (e: MouseEvent) => {
            const bb = canvasOverlayDiv.getBoundingClientRect();
            const x = e.clientX - bb.left;
            const y = e.clientY - bb.top;
