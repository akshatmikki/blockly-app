...
abstract class MutatorHelper implements Mutation {
    ...
    constructor(b: Blockly.Block, protected info: pxtc.SymbolInfo) {
        ...
        this.block.setMutator(new Blockly.icons.MutatorIcon(mutatorToolboxTypes, b as Blockly.BlockSvg));
    }
    ...
    public compileMutation(e: Environment, comments: string[]): pxt.blocks.JsNode {
        return undefined;
    }
...
class DestructuringMutator extends MutatorHelper {
    ...
    private parameterTypes: pxt.Map<string>;
    private parameterRenames: pxt.Map<string> = {};
...
class ArrayMutator extends MutatorHelper {
    ...
    public compileMutation(e: Environment, comments: string[]): pxt.blocks.JsNode {
        const values: pxt.blocks.JsNode[] = [];
